...
export default function PoppularFoods() {
  ...
  return (
    <section className="bg-[url('/background/poppular-foods-bg.png')] bg-no-repeat bg-cover">
      <div className="bg-[linear-gradient(180deg,_rgba(0,_0,_0,_0.32)_4.4%,_rgba(231,_231,_231,_0)_50.78%,_rgba(0,_0,_0,_0.32)_87.24%)] flex flex-col gap-4 py-6 lg:py-32 px-7 lg:px-36">
        <h1 className="text-2xl lg:text-6xl leading-[5rem] font-bold text-white capitalize text-center lg:text-left lg:inline-flex items-center gap-3">
