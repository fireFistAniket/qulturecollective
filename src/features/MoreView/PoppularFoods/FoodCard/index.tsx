...
export default function FoodCard({
  ...
  return (
    <Card className="border-0 shadow-[60px_42px_120px_0px_#00000014] bg-white/90 rounded-sm px-2 py-3 lg:py-5 lg:px-6 shrink-0 h-full">
      <CardContent className="relative p-0 border-0">
        <Image
          ...
          width={392}
          height={418}
          className="h-56 lg:h-[26.14rem] object-cover mb-5 lg:mb-9 rounded-sm w-full"
        />
