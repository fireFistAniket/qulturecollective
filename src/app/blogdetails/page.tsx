...
export default async function BlogDetails() {
  ...
  return (
    <>
      <section className="flex flex-col lg:flex-row items-center lg:items-stretch justify-center lg:px-28 lg:py-24 pt-20 lg:pt-24">
        <div className="flex flex-col gap-8 px-4 lg:max-w-5xl">
          <Image
            ...
            height={617}
          />
          <div className="flex flex-col lg:flex-row-reverse items-start justify-between gap-3">
          ...
          <div className="flex flex-col lg:flex-row gap-4 justify-between">
            <div className="flex items-center justify-center gap-2 bg-[linear-gradient(90deg,_#095143_0%,_#01745D_100%)] w-full lg:w-auto lg:px-6 rounded-lg">
              <h3 className="text-white leading-[4rem] font-bold text-xs lg:text-xl/[4rem]">
                Overall Qulture Star Rating: 4.8/5
              </h3>
              <Star className="fill-[#FBBC04] text-[#FBBC04] size-4 lg:size-8" />
            </div>
            <div className="flex items-center justify-between lg:gap-12">
              ...
              <button
                type="button"
                className="rounded px-7 py-2 bg-[#4285F4] inline-flex gap-1 text-white text-xs lg:text-2xl items-center"
              >
                <span>Share</span>
                <Share className="size-3 lg:size-6" />
              </button>
            </div>
          </div>
          <div className="text-base text-[#464646] lg:text-2xl lg:leading-[2.75rem]">
          ...
          <div className="flex bg-[#FF89291A] rounded-md overflow-hidden">
            ...
            <div className="text-[#525252] text-xs lg:text-3xl tracking-[0.02em] py-3 px-5 lg:py-7 lg:px-14">
          ...
          <div className="shadow-[0px_0px_24px_0px_#CACACA40] p-5 flex flex-col gap-5">
            <h1 className="text-site-green text-base font-bold tracking-[0.01em] lg:text-3xl">
              Qulture Rating
            </h1>
            <div className="bg-[#B4B4B4] h-1"></div>
            <ul className="flex flex-col gap-2 lg:gap-7 list-disc ml-4">
              {qultureRating.map((item, index) => (
                <li key={index} className="flex gap-2 lg:gap-7">
                  <span className="capitalize text-sm lg:text-2xl text-[#2f3030]">
                    {item.title}
                  </span>
